...
static const secp256k1_fe secp256k1_const_beta =
    SECP256K1_FE_CONST(0x7ae96a2bul, 0x657c0710ul, 0x6e64479eul, 0xac3434e9ul,
                       0x9cf04975ul, 0x12f58995ul, 0xc1396c28ul, 0x719501eeul);

/** Normalize a field element. This brings the field element to a canonical
 * representation, reduces its magnitude to 1, and reduces it modulo field size
 * `p`.
 */
static void secp256k1_fe_normalize(secp256k1_fe *r);

/** Weakly normalize a field element: reduce its magnitude to 1, but don't fully
 * normalize. */
...
/** Verify whether a field element represents zero i.e. would normalize to a
 * zero value, without constant-time guarantee. */
static int secp256k1_fe_normalizes_to_zero_var(const secp256k1_fe *r);

/** Set a field element equal to a small (not greater than 0x7FFF), non-negative
 * integer. Resulting field element is normalized; it has magnitude 0 if a == 0,
 * and magnitude 1 otherwise.
 */
 ...
 * Both *r and *a must be initialized.*/
