...
static inline void fadd(uint64_t *out, uint64_t *f1, uint64_t *f2) {
  asm volatile(
      ...
      // Step 3: Fold the carry bit back in; guaranteed not to carry at this
      // point
      "  mov $0, %%rax;"
      "  cmovc %0, %%rax;"
      "  add %%rax, %%r8;"
...
static inline void fmul(uint64_t *out, uint64_t *f1, uint64_t *f2,
  ...
  asm volatile(
      ...
      : "+&r"(f1), "+&r"(f2), "+&r"(tmp)
      : "r"(out)
      : "%rax", "%rbx", "%rdx", "%r8", "%r9", "%r10", "%r11", "%r13", "%r14",
        "memory", "cc");
}
...
static inline void fmul2(uint64_t *out, uint64_t *f1, uint64_t *f2,
                         uint64_t *tmp) {
  asm volatile(
...
static inline void fmul_scalar(uint64_t *out, uint64_t *f1, uint64_t f2) {
  ...
  asm volatile(
      ...
      : "+&r"(f2_r)
      : "r"(out), "r"(f1)
      : "%rax", "%rbx", "%rcx", "%r8", "%r9", "%r10", "%r11", "%r13", "memory",
        "cc");
}
