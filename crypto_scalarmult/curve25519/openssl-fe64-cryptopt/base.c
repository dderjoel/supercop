...
// This guy over here is used in the is_fe64eligible method.
// here, we skip populating it, becuase its not called. but we need it to be
// able to link the asm file to some spot in memory
unsigned int OPENSSL_ia32cap_P[4];
// from crypto/ec/curve25519.c:211
