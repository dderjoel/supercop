...
/** Set a scalar from a big endian byte array. The scalar will be reduced modulo
 * group order `n`. In:      bin:        pointer to a 32-byte array. Out:     r:
 * scalar to be set. overflow:   non-zero if the scalar was bigger or equal to
 ...
 * where r1 and r2 or their negations are maximum 128 bits long (see
...
static void secp256k1_scalar_cmov(secp256k1_scalar *r,
                                  const secp256k1_scalar *a, int flag);
